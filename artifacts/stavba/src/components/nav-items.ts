import {
  ...
  ShieldCheck, KeyRound, BarChart3, Receipt, Bug, Activity, FolderKanban, CircuitBoard, ScanText, ClipboardList,
} from "lucide-react";
...
export const adminNavItems: NavItem[] = [
  { href: "/admin/switchboard-audit", icon: ScrollText, label: "Audit rozvaděčů", shortLabel: "Audit RZ", color: "text-cyan-600", activeBg: "bg-cyan-600 text-white", hoverBg: "hover:bg-cyan-50 hover:text-cyan-700 dark:hover:bg-cyan-950/30", requires: "switchboards.audit.view" },
  { href: "/admin/switchboard-templates", icon: ClipboardList, label: "Šablony rozvaděčů", shortLabel: "Šablony", color: "text-cyan-600", activeBg: "bg-cyan-600 text-white", hoverBg: "hover:bg-cyan-50 hover:text-cyan-700 dark:hover:bg-cyan-950/30", requires: "switchboards.templates.manage" },
  ...
  { href: "/admin/external-accounts", icon: KeyRound, label: "Externí účty", shortLabel: "Externí", color: "text-rose-600", activeBg: "bg-rose-600 text-white", hoverBg: "hover:bg-rose-50 hover:text-rose-600 dark:hover:bg-rose-950/30", requires: "users.manage" },

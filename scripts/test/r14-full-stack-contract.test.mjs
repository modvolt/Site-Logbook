...
test("runner enforces exact provenance, restore/fault proof, and unconditional teardown", () => {
  for (const marker of [
    ...
    '"pg_dump"',
    '"pg_restore"',
    'setServiceNetworkConnected("minio", false)',
    'setServiceNetworkConnected("minio", true)',
    'setServiceNetworkConnected("postgres", false)',
    'setServiceNetworkConnected("postgres", true)',
    '"network", "disconnect"',
    '"network",\n        "connect"',

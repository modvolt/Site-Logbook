...
export const jobsTable = pgTable("jobs", {
  ...
  notes: text("notes"),
  hoursSpent: numeric("hours_spent", { precision: 9, scale: 2 }),
  hoursFromPlan: boolean("hours_from_plan").notNull().default(false),
  hoursBeforePlan: numeric("hours_before_plan", { precision: 9, scale: 2 }),
  hoursVasek: numeric("hours_vasek", { precision: 9, scale: 2 }),
  hoursJonas: numeric("hours_jonas", { precision: 9, scale: 2 }),

...
- Name: warehouse-delete.spec.ts >> Warehouse delete guard >> shows success toast and removes item when deleting a fresh item via UI
- Location: tests/warehouse-delete.spec.ts:42:7
...
Locator: getByText('Položka smazána', { exact: true })
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByText('Položka smazána', { exact: true })

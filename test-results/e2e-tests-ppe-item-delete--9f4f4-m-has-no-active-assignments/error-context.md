...
- Name: e2e/tests/ppe-item-delete.spec.ts >> PPE item – archive guard (active assignments) >> returns 200 via API when item has no active assignments
- Location: e2e/tests/ppe-item-delete.spec.ts:37:7

...
- Name: e2e/tests/ppe-item-delete.spec.ts >> PPE item – archive guard (active assignments) >> returns 409 with Czech message via API when item has active assignments
- Location: e2e/tests/ppe-item-delete.spec.ts:4:7
